...
- `open_ssh_tunnel_vllm.sh`: open an SSH tunnel to a remote compute node running vLLM
- `vllm_api`: code to communicate with a remote instance of [vLLM](https://vllm.ai) through a web browser using [FastAPI](https://fastapi.tiangolo.com).
